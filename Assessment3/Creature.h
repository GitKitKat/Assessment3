...
public:
	...
	// Stores the tiles that can be walked over (includes traps) to the creature
...
protected:
	...
	Play::Point2D creaturePos;
	// Stores the positions of tiles that can be walked over (includes traps)
	std::map<float, std::vector<Play::Point2D>> openBoundaries;
